...
echo "open-id config | http://${HOST_NAME}/irisauth/oauth2/.well-known/openid-configuration"
...
echo "CSP based client server2 SMP | http://${HOST_NAME}/irisclient2/csp/sys/%25CSP.Portal.Home.zen"
